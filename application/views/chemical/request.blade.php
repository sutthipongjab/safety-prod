        ...
        <div class="card w-full  shadow-2xl bg-base-100">
            <div class="card-body">
                ...
                {{-- <div class="bg-green-200 rounded-lg">
                    มีรายการสารเคมีนี้ ในฐานข้อมูลบริษัทฯ แล้ว ต้องการขอมีใช้ ในแผนกของท่าน
                </div>
                

                ยังไม่มี สารเคมีนี้ ในฐานข้อมูลบริษัทฯ ต้องการขอมีสารเคมีใหม่  --}}
                ...
                <div id="chemical_detail" class=" " >
                    ...
                    <label class="form-control w-full max-w-xs hidden">
                        <div class="label">
                            <span class="label-text">ผู้ขอใช้สารเคมี</span>
                        </div>
                    ...
                    <div class="flex-col lg:flex-row searching gap-5 hidden">
                        <label class="form-control w-full max-w-xs">
                            <div class="label">
                                <span class="label-text">ค้นหาสารเคมี หรือ ID ที่ต้องการเพิ่ม</span>
                            </div>
                            <input type="text" placeholder="Acetylene gas หรือ 3" id="keySearch" class="input input-bordered w-full max-w-xs" />
                        </label>
                        ...
                        <label class="form-control w-full max-w-xs hidden">
                            ...
                            <select class="select select-bordered h-32"  size="5" id="chemicalList"></select>
                        </label>
                    </div>
                    ...
                    <form class="detail hidden" enctype="multipart/form-data">
                        ...
                        <div class="body border rounded-lg p-5">
                            ...
                            <input type="text" id="EFFECTIVE_DATE" name="EFFECTIVE_DATE" class="hidden" />
                            ...
                            <div class="flex flex-col lg:flex-row  gap-5">
                                ...
                                <label class="form-control w-full max-w-xs">
                                    <div class="label">
                                        <span class="label-text">ปริมาณที่ใช้</span>
                                    </div>
                                    <div class="flex gap-1">
                                        <input type="number" step=0.1  placeholder="3" id="QUANTITY_KG" name="QUANTITY_KG" class="input input-bordered w-full max-w-xs req" />
                                        <select class="select select-bordered w-28" id="QUANTITY_TYPE" name="QUANTITY_TYPE">
                                            <option value="1">kg/วัน</option>
                                            <option value="2">kg/เดือน</option>
                                        </select>
                                    </div>
                                </label>
                            </div>
                            ...
                            <label class="form-control w-full max-w-xs">
                                <div class="label">
                                    <span class="label-text">แนบไฟล์ Layout</span>
                                </div>
                                <input type="file" id="KEEPING_POINT_FILE" name="KEEPING_POINT_FILE" accept="application/pdf" class="file-input file-input-bordered w-full max-w-xs req" />
                            </label>
                            {{-- <label class="form-control w-full">
                                <div class="label">
                                ...
                                <div class="flex gap-1">
                                    <select class="select select-bordered w-full req" id="USER_CONTROL" name="USER_CONTROL" multiple>
                                    <div class="flex flex-col flex-1 inputGroup gap-1">
                                        <input type="text" placeholder="กรอกรหัสผู้ควบคุม e.g. 13249" name="USER_CONTROL[]" class="input input-bordered w-full req" />
                                    </div>
                                    <div class="flex flex-col justify-end">
                                        <i class="icofont-minus-square text-5xl hover:text-gray-400 hover:scale-105 remove-usrCT hidden"></i>
                                        <i class="icofont-plus-square text-5xl  hover:text-gray-400 hover:scale-105 add-usrCT"></i>
                                    </div>
                                </div>
                            </label> --}}
...
@section('scripts')
    <script src="{{ $GLOBALS['script'] }}chemicalRequest.bundle.js?ver={{ date('Ymdhis') }}"></script>
@endsection
